...
namespace ColorCode
{
    namespace WFP
    {
        ...
        {
            public RichTextBlockFormatter() : this(false)
            {
            }

            public RichTextBlockFormatter(bool IsDark = false) : this(IsDark ? StyleDictionary.DefaultDark : StyleDictionary.DefaultLight, null)
            {
            }
            ...
            public RichTextBlockFormatter(ILanguageParser? languageParser) : this(StyleDictionary.DefaultLight, languageParser)
            {
            }
            ...
            /// <param name="RichText">The Control to add the Text to. RichTextBlock</param>
            public void FormatRichTextBlock(string sourceCode, ILanguage Language, FlowDocument RichText)
            {
